...
int main()
{
  struct tsl_global_scope_t* global_scope = tsl_parser_parse("string someVar123 = \"hello\"; string y = someVar123;");
  ...
  if (strcmp(variable->value.as_string, "hello") != 0) // should be copied from someVar123
  {
