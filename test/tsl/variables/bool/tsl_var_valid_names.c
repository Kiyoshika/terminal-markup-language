...
int main()
{
  ...
  struct tsl_global_scope_t* var1 = tsl_parser_parse("bool var = true;");
  ...
  var2 = tsl_parser_parse("bool var123 = true;");
  if (!var2)
  {
  ...
  var3 = tsl_parser_parse("bool _var = true;");
  if (!var3)
  {
  ...
  var4 = tsl_parser_parse("bool my_var = true;");
  if (!var4)
  {
