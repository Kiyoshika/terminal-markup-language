...
int main()
{
  ...
  struct tsl_global_scope_t* var1 = tsl_parser_parse("string var;");
  ...
  var2 = tsl_parser_parse("string var123;");
  if (!var2)
  {
  ...
  var3 = tsl_parser_parse("string _var;");
  if (!var3)
  {
  ...
  var4 = tsl_parser_parse("string my_var;");
  if (!var4)
  {
