...
int main()
{
  struct tsl_global_scope_t* global_scope = tsl_parser_parse("float someVar123 = -12.23; float y = someVar123;");
  ...
  if (fabsf(variable->value.as_float - -12.23f) > 0.000001f) // should be copied from someVar123
  {
