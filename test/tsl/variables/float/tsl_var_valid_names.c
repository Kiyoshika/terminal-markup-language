...
int main()
{
  ...
  struct tsl_global_scope_t* var1 = tsl_parser_parse("float var = 1.0;");
  ...
  var2 = tsl_parser_parse("float var123 = 1.0;");
  if (!var2)
  {
  ...
  var3 = tsl_parser_parse("float _var = 1.0;");
  if (!var3)
  {
  ...
  var4 = tsl_parser_parse("float my_var = 1.0;");
  if (!var4)
  {
